...
for keymap in emacs vicmd viins; do
  ...
  case "$TERM_PROGRAM" in
  Apple_Terminal) bindkey -M $keymap "^[u" dirhistory_zle_dirhistory_up ;;  # Terminal.app
  ...
  case "$TERM_PROGRAM" in
  Apple_Terminal) bindkey -M $keymap "^[d" dirhistory_zle_dirhistory_down ;;  # Terminal.app
